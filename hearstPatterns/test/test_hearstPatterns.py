...
class TestHearstPatterns(unittest.TestCase):
	...
	def test_hyponym_finder(self):
		...
		hyps6 = h.find_hyponyms("There are such benefits as postharvest losses reduction, soil fertility improvement, and food increase.")
		self.assertEqual(hyps6[0], ("postharvest loss reduction", "benefit"))
		self.assertEqual(hyps6[1], ("soil fertility improvement", "benefit"))
		self.assertEqual(hyps6[2], ("food increase", "benefit"))
